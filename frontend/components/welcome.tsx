  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-2xl rounded-3xl border border-gray-200/40 bg-white/60 px-6 py-10 shadow-2xl backdrop-blur-2xl dark:border-gray-700/40 dark:bg-gray-900/70">
        ...
        >
          <div className="flex items-center justify-center rounded-xl border border-gray-200/50 bg-white/50 p-4 backdrop-blur-sm dark:border-gray-700/50 dark:bg-gray-800/50">
            <div className="text-center">
              <div className="mx-auto mb-2 flex h-8 w-8 items-center justify-center rounded-full bg-blue-100 dark:bg-blue-900/30">
                <svg
          ...
          <div className="flex items-center justify-center rounded-xl border border-gray-200/50 bg-white/50 p-4 backdrop-blur-sm dark:border-gray-700/50 dark:bg-gray-800/50">
            <div className="text-center">
              <div className="mx-auto mb-2 flex h-8 w-8 items-center justify-center rounded-full bg-purple-100 dark:bg-purple-900/30">
                <svg
